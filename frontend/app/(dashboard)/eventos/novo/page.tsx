...
export default function NovoEventoPage() {
  ...
  async function handleSubmit(event: React.FormEvent<HTMLFormElement>) {
    ...
    const erroDescricao = validarDescricaoVitrine(form.descricao);
    if (erroDescricao) {
  ...
  return (
    <AdminShell
      title="Novo evento"
      subtitle="Após criar, adicione o flyer na tela de gerenciamento"
    >
      <form
      ...
      >
        ...
        <div className="space-y-2">
          ...
          <p className="text-xs text-zinc-500">
            {contarPalavras(form.descricao)}/{EVENTO_DESCRICAO_MAX_PALAVRAS}{" "}
            palavras
          </p>
        </div>
